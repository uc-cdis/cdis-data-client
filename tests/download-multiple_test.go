...
// 	mockGen3Interface.
// 		EXPECT().
// 		GetResponse(testProfileConfig, commonUtils.ShepherdEndpoint+"/objects/"+testGUID, "GET", "", nil).
...
// 	mockGen3Interface.
// 		EXPECT().
// 		DoRequestWithSignedHeader(testProfileConfig, commonUtils.IndexdIndexEndpoint+"/"+testGUID, "", nil).
